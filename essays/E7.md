...
<ul>
  ...
  <li> 
    <h5>Understanding why MIS people need basic programming skills and knowledge:</h5>
      <p>
        During our lectures we went over how some codes are used in programming, which we used in our labs to undergo more understanding of what those code do. This then lead to algorithmic thinking. Undertanding basic programming skills and knowledge helped us to thinka algorithmically, especially when we practice the day of week lab and wod to practice algorithmic thinking.
      </p>
  </li>
...
<h2 id="AI">Use of AI (e.g. ChatGBT)</h2>
<ul>
  <li>
    ...
    <p>
      I have mentioned this above in <a href="#Chat">how I overcame my challenges</a>, but I will elaborate further here. I used ChatGPT to understand more operations, syntaxes, why my code was not working, and css formatting for html (debatable). I ask chat why my code is not working and throws me some code (that does not work for the application I was working on) that I can use to try and understand what I was doing wrong, this may be wrong syntaxes or wrong operations. I ask chat why the code works and why does it work. With this I can understand more of the code. For example it would spew out "if(normal !== abnormal)" and I can highlight the "!==" and ask "what is the difference between using !== and ===?" and answer with a example of how they are both used and summarices " '!==' checks for inequality without type conversion. '===' checks for equality with type conversion." Chat would also tell you if your code is poor programming practices and shows you a better practice. 
    </p>
  </li>
